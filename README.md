...
## Краткое резюме
- Роль: **Senior Software Engineer / Tech Lead**
- Фокус: масштабируемые web-системы, дизайнерские интерфейсы, CI/CD, observability
- Стек: **TypeScript • React • Next.js • Node • Go • Docker • Kubernetes • Terraform**
...
## Цели на год (OKR-подход)
1. Улучшить uptime ключевого сервиса до 99.99%
2. Оптимизировать bundle-size основных приложений (-25%)
3. Опубликовать 3 OSS пакета с тестами и CI
4. Провести 2 доклада на конференциях

---

## Что читаю / подписки
- Книги: Designing Data-Intensive Applications; Refactoring
- Подкасты: Software Engineering Daily, The Changelog
- Блоги: CSS-Tricks, Smashing Magazine, Dev.to

---

## Инструменты визуализации (иконки)
<p align="center">
  <img src="https://skillicons.dev/icons?i=ts,react,nextjs,nodejs,go,python,docker,kubernetes,terraform,postgres,redis" alt="tech stack" />
</p>

---

## Open-source вклад и maintenance
